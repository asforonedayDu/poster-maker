...
<style scoped>
  ...
  .color-picker .color-picker-inner .color-picker-up {
    display: -webkit-box;
    display: -ms-flexbox;
    display: flex;
    height: 204px;
  ...
  .color-picker .color-picker-inner .color-picker-up .color-panel {
    width: 92%;
    margin-right: 14px;
  }

  .color-picker .color-picker-inner .color-picker-up .color-sidebar {
    -webkit-box-flex: 1;
    -ms-flex: 1;
    flex: 1;
  }

  .color-picker .color-picker-inner .color-opacity,
  .color-picker .color-picker-inner .color-select {
    width: 92%;
  }
  ...
  .color-picker .color-picker-inner .color-picker-down {
    display: -webkit-box;
    display: -ms-flexbox;
    display: flex;
  ...
  .color-picker .color-picker-inner .color-picker-down .color-number {
    width: 50%;
  }

  .color-picker .color-picker-inner .color-picker-down .color-number input {
    width: 100%;
    padding: 6px 8px;
  ...
  .color-picker .color-picker-inner .color-picker-down .color-random {
    margin-left: auto;
    margin-right: 16px;
    color: #409eff;
    cursor: pointer;
  ...
  .color-picker .color-picker-inner .color-picker-down .color-random:hover {
    text-decoration: underline;
  }

  .color-picker .color-picker-inner .color-picker-down .color-confirm {
    padding: 8px 16px;
    border: 1px solid #ddd;
    border-radius: 4px;
    cursor: pointer;
  ...
  .color-picker .color-picker-inner .color-picker-down .color-confirm:hover {
    color: #409eff;
    border-color: #409eff;
  }
